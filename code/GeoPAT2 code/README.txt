...
2. Change directory to folder containing pre processed climate data rasters. 
3. Copy and paste commands from file "processing_script.txt" in "GeoPAT2 code" folder into command line module. If similarity including Lima, Kinshasa and Jakarta is required
